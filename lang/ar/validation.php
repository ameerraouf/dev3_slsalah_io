...
return [
    ...
    */
    'attributes' => [
        ...
        'subtitle_one' => 'العنوان الفرعي الأول',
        'subtitle_two' => 'العنوان الفرعي الثاني',
        'text' => 'نص',
        'image_title' => 'عنوان الصورة',
        'image_subtitle' => 'عنوان فرعي للصورة',
        'total_words' => 'إجمالي الكلمات',
        'total_images' => 'إجمالي الصور',
        'features' => 'المميزات',
        'language' => 'اللغة',
        'your_description' => 'الوصف',
        'article_title' => 'عنوان المقال',
        'text_to_summary' => 'الملخص',
        'product_name' => 'اسم المنتج',
        'seed_words' => 'الكلمات',
        'subject' => 'الموضوع',
        'keywords' => 'الكلمات المفتاحية',
        'maximum_length' => 'الطول الاقصى',
