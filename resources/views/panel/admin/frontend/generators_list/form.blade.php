                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="menu_title" name="menu_title" value="{{$item!=null ? __($item->menu_title) : null}}"  >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="subtitle_one" name="subtitle_one" value="{{$item!=null ? __($item->subtitle_one) : null}}"  >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="subtitle_two" name="subtitle_two" value="{{$item!=null ? __($item->subtitle_two) : null}}"  >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="text" id="text" class="form-control" rows="10"  >{{$item!=null ? __($item->text) : null}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="image_title" name="image_title" value="{{$item!=null ? __($item->image_title) : null}}"  >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="image_subtitle" name="image_subtitle" value="{{$item!=null ? __($item->image_subtitle) : null}}"  >
                                        </div>
                                    </div>
