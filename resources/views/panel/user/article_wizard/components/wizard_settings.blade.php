<div class="row row-cards">
    ...
    <div class="col-12 col-sm-6 col-lg-5 lg:pr-14" id="settings">
        ...
        <form class="row" id="article_wizard_setting_form">
            ...
            <div class="col-xs-12 mt-[10px]">
                <button id="generator_btn" class="btn bg-[#f1edff] hover:bg-[#c1bDFF] text-[#000] w-100 py-[0.75em] flex items-center group dark:bg-[--lqd-gray] dark:text-white" type="submit">
                ...
                <button type="button" class="btn bg-[#fff] hover:bg-[#c1bDFF] text-[#000] w-100 py-[0.75em] flex items-center group hidden mt-[1.5rem] dark:bg-white/5 dark:text-white" id="skip_image">
                    {{ __('Skip this step') }}
                </button>
            </div>
    ...
    <div class="relative col-12 col-sm-6 col-lg-7 lg:pl-16 lg:border-l lg:border-solid border-t-0 border-r-0 border-b-0 border-[var(--tblr-border-color)] [&_.tox-edit-area__iframe]:!bg-transparent hidden"
        ...
        <div class="card-body mb-10">
            <div
                class="flex-nowrap mb-[10px] flex justify-between items-center p-[16px] border-[--tblr-border-color] border-[1px] border-solid rounded-[10px]">
            ...
            <div class="row">
                <div id="next_btn" class="hidden">
                    <div class="col-xs-12 mt-[30px]">
                        <button id="next_page_btn" class="btn bg-[#f1edff] hover:bg-[#c1bDFF] text-[#000] w-100 py-[0.75em] flex items-center group dark:bg-[--tblr-primary] dark:text-white" onclick="goNextStep()">
                            <span class="hidden group-[.lqd-form-submitting]:inline-flex">{{ __('Please wait...') }}</span>
                            <span class="group-[.lqd-form-submitting]:hidden flex items-center">
								{{ __('Next') }}
								<span class="flex items-center justify-center my-0 mx-2 w-[30px] h-[30px] shrink-0 text-xl bg-[#fff] rounded-full text-center text-black">
									<svg width="6" height="10" viewBox="0 0 6 10" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path d="M0.810285 0.54241C0.881713 0.54241 0.962071 0.578125 1.01564 0.631696L5.17636 4.79241C5.22993 4.84598 5.26564 4.92634 5.26564 4.99777C5.26564 5.0692 5.22993 5.14955 5.17636 5.20312L1.01564 9.36384C0.962071 9.41741 0.881713 9.45312 0.810285 9.45312C0.738856 9.45312 0.658498 9.41741 0.604927 9.36384L0.158499 8.91741C0.104928 8.86384 0.0692139 8.79241 0.0692139 8.71205C0.0692139 8.64062 0.104928 8.56027 0.158499 8.5067L3.66743 4.99777L0.158499 1.48884C0.104928 1.43527 0.0692139 1.35491 0.0692139 1.28348C0.0692139 1.21205 0.104928 1.1317 0.158499 1.07812L0.604927 0.631696C0.658498 0.578125 0.738856 0.54241 0.810285 0.54241Z" />
									</svg>
								</span>
                            </span>
                        </button>
