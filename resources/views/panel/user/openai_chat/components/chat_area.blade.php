...
@if (count($chat->messages) == 0)
    {{-- <div class="flex flex-col justify-center items-center h-full">
        <p>Upload an image and ask me anything</p>
        <button
            class="btn bg-[#f1edff] hover:bg-[#c1bDFF] text-[#000] w-fit py-[0.5em] flex items-center group dark:bg-[--lqd-gray] dark:text-white my-[0.5em]">Explain
            an Image</button>
        <button
            class="btn bg-[#f1edff] hover:bg-[#c1bDFF] text-[#000] w-fit py-[0.5em] flex items-center group dark:bg-[--lqd-gray] dark:text-white my-[0.5em]">Summarize
            a PDF for Research</button>
        <button
            class="btn bg-[#f1edff] hover:bg-[#c1bDFF] text-[#000] w-fit py-[0.5em] flex items-center group dark:bg-[--lqd-gray] dark:text-white my-[0.5em]">Translate
            a book</button>
    </div>
@else
