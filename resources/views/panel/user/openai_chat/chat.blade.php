...
@section('title', ($category->slug == 'ai_vision' ? __('Vision AI') : ($category->slug == 'ai_pdf'? __('AI PDF') :  __('AI Chat')) ))
            ...
            <div class="items-center row g-2">
                <div class="col">
                    ...
                    <h2 class="mb-2 page-title">
                        {{ ($category->slug == 'ai_vision' ? __('Vision AI') : ($category->slug == 'ai_pdf'? __('AI PDF') :  __('AI Chat')) ) }}
                    </h2>
            ...
            <div class="card">
                <div class="p-0 card-body" id="scrollable_content">
                    <div id="user_chat_area" class="flex overflow-hidden h-[75vh] max-md:flex-col-reverse max-md:h-auto">
                        ...
                        <div class="flex flex-col lg:w-full grow" id="load_chat_area_container">
                            @if ($chat != null)
    ...
    <template id="chat_user_image_bubble">
        <div class="lqd-chat-image-bubble flex flex-row-reverse content-end mb-2 lg:ms-auto gap-[8px]">
            <div
                ...
                <img class="img-content py-[0.75rem] px-[1.5rem]" src="" />
            </div>
        </div>
    </template>
...
@section('script')
    ...
    @else
        ...
        <script>
            ...
            function saveResponse(input, response, chat_id, imagePath, pdfName, pdfPath) {
                "use strict";
