            ...
            <div class="image-result group">
                <div class="relative aspect-square rounded-lg mb-2 overflow-hidden group-hover:shadow-lg transition-all">
                    ...
                    <div class="flex items-center justify-center gap-2 w-full h-full absolute top-0 left-0 opacity-0 transition-opacity group-hover:!opacity-100">
                        <a href="" title="تنزيل" class="btn items-center justify-center w-9 h-9 p-0 download" download>
                        ...
                        <a data-fslightbox="gallery" title="عرض" href="" class="btn lb items-center justify-center w-9 h-9 p-0 gallery" data-type="image">
                        ...
                        <a href="" title="حذف" onclick="return confirm('Are you sure?')" class="btn items-center justify-center w-9 h-9 p-0 delete">
