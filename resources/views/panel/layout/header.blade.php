                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ route('dashboard.user.openai.articlewizard.new') == url()->current() ? 'active' : '' }}"
                                ...
                                @if (env('APP_STATUS') == 'Demo') 
                                    <span class="inline-flex items-center rounded-md bg-purple-50 px-2 py-1 text-xs font-medium text-purple-700 ring-1 ring-inset ring-purple-700/10">New</span>
                                @endif
                            </a>
                        </li>
                    @endif
                    @if ($setting->feature_ai_pdf)
                        <li class="nav-item">
                            <a class="nav-link {{ route('dashboard.user.openai.generator.workbook', 'ai_pdf') == url()->current() ? 'active' : '' }}"
                                ...
                                <svg width="24" height="24" viewBox="0 0 22 22" fill="none" class="mr-1"
                    ...
                    @if (Auth::user()->type == 'admin')
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ activeRoute('dashboard.admin.ads.index') }}"
                                ...
                                <span
                                    class="flex ms-1 items-center transition-[opacity,transform] nav-link-title grow">
                                    {{ __('Google Adsense') }}
                                </span>
                            </a>
                        </li>
