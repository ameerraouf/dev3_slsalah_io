...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('payment')->group(function () { 
        ...
        Route::prefix('/plans')->group(function () { 
            Route::get("/{plan_id?}", "App\Http\Controllers\Api\PaymentApiController@plans");
    ...
    Route::post("/dashboard/user/payment/clickpay/subscribe/recurring/callback/{id}",[ClickpayController::class,'recurringCallback']);
