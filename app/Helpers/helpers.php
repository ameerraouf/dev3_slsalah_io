...
function getSubscription(){
    $userId=Auth::user()->id;
    $activeSub = Subscriptions::where([['status', '=', 'active'], ['user_id', '=', $userId]])->orWhere([['status', '=', 'trialing'], ['user_id', '=', $userId]])->first();
    if($activeSub == null) {
...
function getSubscriptionName(){
    $user = Auth::user();
    return \App\Models\PaymentPlans::where('id', getSubscription()->plan_id)->first()->name;
}
