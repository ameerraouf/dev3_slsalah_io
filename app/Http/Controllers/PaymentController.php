...
use App\Http\Controllers\Gateways\ClickpayController;   
...
class PaymentController extends Controller
{
    ...
    public function startSubscriptionProcess($planId, $gatewayCode){
        ...
        if($plan != null){
            ...
            if($gatewayCode == 'clickpay'){
                return ClickpayController::subscribe($planId, $plan);
            }
        }
        abort(404);
    }
    ...
    public static function cancelActiveSubscription(){
        ...
        if($gatewayCode == 'clickpay'){
            return ClickpayController::subscribeCancel();
        }
    ...
    public function startPrepaidPaymentProcess($planId, $gatewayCode){
        ...
        if($plan != null){
            ...
            if($gatewayCode == 'clickpay'){
                return ClickpayController::prepaid($planId, $plan);
            }
        }
        abort(404);
    }
    ...
    public static function getSubscriptionDaysLeft(){
        ...
        if($activeSub != null){
            ...
            if($paid_with == 'clickpay'){
                return ClickpayController::getSubscriptionDaysLeft();
            }
        }else{
    ...
    public static function getSubscriptionStatus(){
        ...
        if($activeSub != null){
            switch ($activeSub->paid_with) {
                ...
                case 'clickpay':
                    return ClickpayController::getSubscriptionStatus();
                    break;
            ...
            if($subscriptions != null){
                foreach ($subscriptions as $subscription) {
                    ...
                    switch ($subscription->paid_with) {
                        ...
                        case 'clickpay':
                            $tmp = ClickpayController::cancelSubscribedPlan($planId, $subsId);
                            break;
                    }
                }
            }
